...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Characters = __webpack_require__(160);
	var CharacterBox = __webpack_require__(161);
	var GuessForm = __webpack_require__(162);
	var QuestionForm = __webpack_require__(163);
	...
	var GameBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { key: this.state.characters.id, className: 'charachter-box' },
	        React.createElement(CharacterBox, { characters: this.state.characters })
	      ),
	      React.createElement(
	        'div',
	        { className: 'question-form' },
	        React.createElement(QuestionForm, { info: this.state.characters, answer: this.randomCharacter })
	      ),
	      React.createElement(
	        'div',
	        { className: 'guess-form' },
	        React.createElement(GuessForm, { names: this.state.characters, answer: this.randomCharacter.name })
	      )
	    );
	  }
	});
	...
	var CharacterBox = React.createClass({
	  ...
	  render: function render() {
	    var character = this.props.characters.map(function (char) {
	      return React.createElement(
	        'div',
	        { key: char.id, className: char.name },
	        React.createElement('img', { src: char.img }),
	        React.createElement(
	          'h3',
	          null,
	          char.name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GuessForm = React.createClass({
	  ...
	  guess: function guess(e) {
	    e.preventDefault();
	    var newGuess = e.target.value;
	    this.setState({ selected: newGuess });
	  },
	
	  revealAnswer: function revealAnswer(guess) {
	    console.log('clicked');
	    console.log(guess);
	  ...
	  render: function render() {
	    var characters = this.props.names.map(function (character) {
	      return React.createElement(
	        'option',
	        { key: character.id, value: character.name },
	        character.name
	      );
	    });
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'select',
	          { value: this.state.selected, onSubmit: this.guess },
	          characters
	        ),
